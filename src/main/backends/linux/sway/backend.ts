...
/**
 * This backend is used on Sway. It uses the hyprland backend as a template, which
 * itself uses the generic wlroots backend and adds the
 * missing functionality using the hyprctl command line utility and the
 * hyprland-global-shortcuts-v1 Wayland protocol.
 * Here we will attempt to mimic this approach on sway, employing swaymsg and **Idunnoyet**
 */
export class SwayBackend extends WLRBackend {
  /**
...
`
  ...
  public async getWMInfo() {
    ...
    // for sway look at this: https://gist.github.com/lidgnulinux/33a28be6a1352cb84d7c6c8b63b5a5c2
    ]);
